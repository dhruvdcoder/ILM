...
# use command: sbatch --job-name=arlm_vstar_medium scripts/train_arlm_vstar_medium.sh
...
srun python -O src/pcdd/commands/lightning_main_v2.py \
    ...
    "datamodule.val_dataloader_kwargs.batch_size=${batch_size}" \
