...
#SBATCH --constraint="vram80,bf16"  # ib for infiniband
...
# sbatch --job-name=mdlm_stories_v2 --mail-user=absahoo@umass.edu scripts/train_mdlm_stories_multi_node.sh
...
wandb_job_id=train_mdlm_lm1b_31947357 # wandb job id from command line (use for resuming)
...
srun python -O src/pcdd/commands/lightning_main_v2.py \
    ...
    "+loggers.wandb.notes='Train MDLM on lm1b from scratch.'"
