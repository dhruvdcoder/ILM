#!/bin/bash
#SBATCH -o logs/slurm/nll_dataset_lm1b.out          # output file (%j expands to jobID, %x expands to job_name) # TODO: For resuming, use %x only.
...
experiment=lm1b_generative_perplexity
