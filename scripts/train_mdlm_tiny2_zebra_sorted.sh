...
#SBATCH --constraint="(vram40&bf16)|l40s|a40"  # ib for infiniband
...
experiment=mdlm_tiny2_zebra_sorted
batch_size=128
compile=false
precision=bf16-mixed
job_type=train
debug=false
export TQDM_MINITERS=500
...
python -O src/pcdd/commands/lightning_main_v2.py \
    "job_name=${job_name}" \
    "job_type=${job_type}" \
